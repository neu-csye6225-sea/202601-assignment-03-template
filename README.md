...
1. **Clone & Inspect:** 
   ...
   Clone the assignment repository to your local machine. Use the `https://`
...
2. **Security Configuration (Secrets):**
   ...
   the CI/CD pipeline (Github Actions) can run correctly. 
...
permanent record of a repository.  
...
1. **Create and Merge a Pull Request (GH Web Interface):**
   * Navigate to your repo on Github.
   * You should see a prompt to `Compare & pull request` for your `feature/pipeline-setup` branch.
   ...
   * **Review**: Scroll down to the bottom. You may see a message saying "All checks have failed".  **This is expected** 
   at this stage as we haven't tagged the release yet. 
   * Click "Merge pull request", then "Confirm merge".
   * Ensure the status updates to "Pull request successfully merged and closed"
...
4. **Final Verification:**
   ...
   * You should see a workflow run triggered by your tag push. It should look like:
...
| Category | Criteria (Logic Check) | Points |
| --- | --- | --- |
